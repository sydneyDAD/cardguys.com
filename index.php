...
if ($module != 'request') {
    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <head>
            ...
            <link rel="stylesheet" type="text/css" href="<?= $sitelink ?>/css/normalize.css" />
        ...
        <?php include_once("analyticstracking.php") ?>   
            ...
            <div class="home">
                ...
                <div class="menu-top-container">
                    <div>
                        <a href="<?php echo $sitelink; ?>/advice-center">Advice Center</a> | <a href="<?php echo $sitelink; ?>/faq">FAQs</a> | <a href="<?php echo $sitelink; ?>/news/209-About-Us">About Us</a>
			...
			<nav>
                            <ul>
                                <li class="first <?php echo $module=="" ? 'active' :  "";?>"><a href="<?php echo $sitelink; ?>">Home</a></li>
                                <li class="hasnested
                                <?php
                                    if($module=="calculators" || $module=="calculators/" )
                                        echo "active";
                                    else
                                    {
                                        echo "";    
                                ...
                                <li class="<?php echo $module=="advice-center" ? 'active' :  "";?>"><a href="<?= $sitelink ?>/advice-center">Advice Center</a></li>
                                <li class="<?php echo $module=="credit-cards" ? 'active' :  "";?>"><a href="<?= $sitelink ?>/best-credit-card-offers">Best Deals</a></li>
                                <li class="<?php echo $module=="blog" ? 'active' :  "";?>"><a href="<?= $sitelink ?>/blog">Blog</a></li>
                                <li class="<?php echo $module=="contact" ? 'active' :  "";?>"> <a href="<?= $sitelink ?>/contact">Contacts</a></li>
                            </ul>
                        </nav>
                        </div>
                ...
                <? } else { ?>
                    ...
                    <div class="middle-container else"></div>
                            ...
                            <div class="content-menu <?= $extraie4 ?>">
                                <div class="link-menu">
                                    ...
                                    <div class="link-menu-text">
                                        <a href="<?php echo $sitelink ?>glossary">Glossary Of Terms  </a>
                                    </div>
                                </div>
                                <div class="link-menu">

                                    <div class="link-menu-text">
                                        <a href="<?php echo $sitelink ?>faq">FAQ - Get Answers!  </a>
                                    </div>
                                </div>
                                <div class="link-menu">

                                    <div class="link-menu-text">
                                        <a href="<?php echo $sitelink ?>advice-center">Advice Center  </a>
                                    </div>
                                </div>
                                ...
                                <div class="link-menu">
                                    ...
                                    <div class="link-menu-text">
                                        <a href="<?php echo $sitelink ?>blog">Credit Card Blog </a>
                                    </div>
                                </div>
                                ...
                                <div class="link-menu">
                                    ...
                                    <div class="link-menu-text">
                                        <a href="<?php echo $sitelink ?>free-credit-reports">Free Credit Reports </a>
                                    </div>
                                </div>
                ...
                <div class="footter">
                    ...
                    <div class="copyright-container">
                        <div class="inner-copyright-container">
                            <div class="left">
                                Copyright © 2014 CardGuys |  All Rights Reserved
