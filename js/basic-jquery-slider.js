    ...
    $.fn.bjqs = function (options) {
        ...
        if (settings.showMarkers && slideCount > 1) {
            ...
            $.each(slides, function (key, value) {
                ...
                var $slide2 = $(value);
				var $slideOn2 = $slide2.children('div:first-child');
                var $slideChild2 = $slideOn2.children('.slide_image img:first-child');
                var c_img = $slideChild2.attr('src');
                var c_title = $slideChild2.attr('mes1')+' I am what I am';
                var $t_title=c_title;
                var $word_limit=22;
                if(c_title.length>=$word_limit) {
					c_title = $t_title.substr(0,($word_limit+5))+'...';   // Get the visible part of the string
                }
                if (settings.animType === 'slide') {
                    if (key !== 0 && key !== slideCount - 1) {
                        ...
                        $marker = $('<li class=marker_main><a href="#"><img src=\''+ c_img +'\'><p>'+c_title+'</p></a></li>');                                    
                    }
                } else {
                    key++;
                    //$marker = $('<li><a href="#">' + key + '</a></li>');
        ...
        if (settings.useCaptions) {
            ...
            //$.each(slides, function () {
                ...
                var $slide = $(value);//alert(key);
                //var $slide = $(this).;//alert(key);
                //console.log(slide,slide.attr('class'));
				var $slideOn = $slide.children('div:first-child');
				var $slideChild = $slideOn.children('img:first-child');
				//var $slideChild = $slide.children('.slide_image img:first-child');
                //var $slideChild = $slide.children('img:first-child');
                var title2 = $slideChild.attr('mes1');
                var title = $slideChild.attr('mes2');                
                var title3 = $slideChild.attr('mes3');

                if (title) {
                    var $caption = $('<div class="bjqs-caption">' + '<span class=slide_title><A href="'+title3+'">'+ title2 + '</a></span>' + '<br />' + title + '</div>');
