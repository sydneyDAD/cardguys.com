...
$i = 1;
	...
	foreach ($row as $row){
		...
		echo $temp->td('<a href="index.php?module='.$category_blog->module.'&view=form&id='.$row->id.'"><b>'.$row->name.'</b></a>');
		echo $temp->td($row->intro);
