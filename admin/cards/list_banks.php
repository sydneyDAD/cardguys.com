...
$db->update_status($cards_bank->table,$cards_bank->key);
$option = 'delete';$i = 1;
$row = $cards_bank->lists();

?>
<a style="color: #CA4102; font-weight: bold; font-size: 14px; text-decoration: underline;" href="<?=$sitelink?>admin/index.php?module=cards&view=banks">Add New Bank</a>
<?
	...
	foreach ($row as $row){
		...
		echo $temp->td('<a href="index.php?module='.$cards_bank->module.'&view=banks&id='.$row->tbl_id.'"><b>'.$row->name.'</b></a>');
