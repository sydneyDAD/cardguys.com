...
?>
<div  class=infocard>
<div class="title-content-card-top3 <?=$extraie9?>"><span class="text-title-Content-card-top"><?=$row['name']?></span></div>
                   ...
                   <?
                       ...
                       {    $holdcard="";
                            $details = $credit_cards->detail2('OfferName,RedirectLink,alias,BigCreative,TextDetails',$card);
                                ...
                                <div style=\"margin-left: 26px;margin-bottom: -5px;\"><a  title=\"Apply Now\"  href=\"".change_url('index.php?module=request&id='.$card.'&alias='.seourl($details['OfferName']))."\" target=\"_blank\"><img src=\"images/apply_now_button.jpg\" width=\"120px\" height=\"30px\"/></a></div>";
