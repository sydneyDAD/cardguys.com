...
<div class="infocard">
				...
				<div class="title-content-card-top" style="height: 30px;"><span class="text-title-Content-card-top" style="display: block; height: 30px; line-height: 15px;"><?=$template->title_content('CardGuys.com Sitemap')?></span></div>
