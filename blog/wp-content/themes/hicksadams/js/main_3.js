...
(function($) {
    $.fn.dcAccordion = function(options) {
        var defaults = {position: "left", classParent: "sm-parent", classActive: "active", classArrow: "sm-arrow", classCount: "sm-count", classExpand: "sm-current-parent", autoClose: true, speed: 250};
