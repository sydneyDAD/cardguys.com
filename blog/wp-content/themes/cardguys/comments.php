...
<?php if ($comments) : ?>
 <a name="comments2"></a><h4 style="margin-bottom:5px;"><?php comments_number('No Responses','One Response','% Responses' );?></h4>
<br />
...
<?php if ('none' != get_settings("comment_moderation")) { ?>
 <p><small><strong>note:</strong> moderation is enabled and may delay your comment. Please do not resubmit your comment.</small></p>
<?php } ?>
