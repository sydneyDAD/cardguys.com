...
?>
		...
		<div class="menuleft">
			...
			<div class="creditcardbytype">
				...
				<div class="textTitlemenu <?=$extraie5?>"><span class=text_span>BLOG NAVIGATION</span></div>
...
if (have_posts()) : ?>
<div class=b_title>About <?php echo $curauth->display_name ?></div>
<dl>
<dt><?php the_author_image(); ?></dt>
<dd><a href="<?php echo $curauth->user_url; ?>"><?php echo $curauth->user_url; ?></a></dd>
<dt>Profile</dt>
<dd><?php echo $curauth->user_description; ?></dd>
</dl>

<h2 style="margin-top:15px;">Posts by <?php echo $curauth->nickname; ?>:</h2>
...
<div class="date">
			...
			Posted by:<!img src="<?php bloginfo('stylesheet_directory'); ?>/images/icon1.gif" alt="icon1" /> <?php the_author_posts_link(); ?> | 
					<!img src="<?php bloginfo('stylesheet_directory'); ?>/images/icon2.gif" alt="icon2" /> <?php the_category(', ') ?> | 
					<!img src="<?php bloginfo('stylesheet_directory'); ?>/images/icon4.gif" alt="icon4" /> <?php the_time('m/jS, Y') ?><strong>|</strong> <?php edit_post_link('Edit','','<strong>|</strong>'); ?> 
					<!img src="<?php bloginfo('stylesheet_directory'); ?>/images/icon3.gif" alt="icon3" /><?php comments_popup_link('No Comments &raquo;', '1 Comment &raquo;', '% Comments &raquo;'); ?></div>
