...
class cards_bank{
	...
	function add(){
			...
			security::redirect($this->module,'list_banks');
	}
	function edit(){
	...
	function lists($where='',$limit='100',$order=''){ //ordering added 2011-13-04 
		$result = $this->db->lists($this->table,'*',$where,$order,$limit); //order newly added
		$i =0;
