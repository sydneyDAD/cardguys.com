...
class cards_quality{
	...
	function lists($where='',$limit='100',$order=''){

		$result = $this->db->lists($this->table,'*',$where,$order,$limit);
		$i =0;
