...
<?
            ...
            <div class="single-details-card">
				<div class="single-details-card-name-card">
				<!div class="namecardText"><h1><?=$card['OfferName']?> </h1> </div>
			...
			<div class="infocard">
				...
				<div class="details-card-text-infomation <?=$extraie2?>">
					<div class="content-apply-text">
                        ...
                        <img src="<? echo $img; ?> "  style="border-width: 0px;" /></a>

							<a target="_blank" href="<?=change_url('index.php?module=request&id='.$card['tbl_id'].'&alias='.$alias)?>"><img src="images/applynow.gif"/></a>
						</div>
			...
			<div class="infocard">
				...
				<div class="details-card-text-infomation <?=$extraie2?>">
					<div class="content-apply-text-single">
						...
						<div class="applyOnline"><a target="_blank"  href="<?=change_url('index.php?module=request&id='.$card['tbl_id'].'&alias='.$alias)?>" style="font-weight:bold;">Apply online for the <?=$card['OfferName']?> </a> </div>
